...
* Added a CV class.
* The executable now prompts for type confirmation only when it is not already defined by the user.
* Renamed 'flyleaf' into 'first-page'.
* Renamed the 'Document' class (and type) into 'Classic'.
